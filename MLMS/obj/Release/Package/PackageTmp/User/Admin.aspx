...
<asp:Content ID="AdminContent" ContentPlaceHolderID="cph1" runat="server">
    ...
    <div style="float: left; width: 50%;">
        ...
        <div>
            <asp:ListBox runat="server" ID="lstBxHowDidYouHear" Style="min-width: 400px;" AutoPostBack="true" OnSelectedIndexChanged="lstBxHowDidYouHear_SelectedIndexChanged"></asp:ListBox>
        </div>
        <div>
    ...
    <div style="float: left; width: 50%;">
        ...
        <div>
            <asp:ListBox runat="server" ID="lstBxAchieve" Style="min-width: 400px;" AutoPostBack="true" OnSelectedIndexChanged="lstBxAchieve_SelectedIndexChanged"></asp:ListBox>
        </div>
        <div>
    ...
    <div style="float: left; width: 50%;">
        ...
        <div>
            <asp:ListBox runat="server" ID="lstBxObj" Style="min-width: 400px;" AutoPostBack="true" OnSelectedIndexChanged="lstBxObj_SelectedIndexChanged"></asp:ListBox>
        </div>
        <div>
